    ...
    <footer className="bg-white dark:bg-gray-900 py-5 border-t">
      <div className="container px-6 py-8 mx-auto">
        <div className="flex flex-col items-center text-center">
          <a href="#">
            <img
              className="my-2 w-auto h-7"
              src="https://hitu.edu.vn/wp-content/themes/hitutheme/assets/images/logo.png"
              alt
            />
          </a>
          ...
          <p className="max-w-md text-gray-400 text-[12px] mx-auto mt-1 dark:text-gray-400">
            Địa chỉ: Số 20 Tăng Nhơn Phú - Phường Phước Long B - Thành phố Thủ
            Đức - TP. Hồ Chí Minh
          </p>
          <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
            ...
            >
              ...
              <span className="mx-1">Khoa CNTT</span>
            </a>
